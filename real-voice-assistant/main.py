...
class VoiceAssistant:
    ...
    def process_with_openai(self, user_input: str) -> str:
        ...
        system_prompt = (
            "You are a helpful voice assistant with memory and task "
            ...
            "When the user asks you to remember something, use the "
            "save_memory function.\n"
            "When they ask about something they told you before, use "
            "get_memory."
        )
...
def main():
    ...
    if audio_works:
        ...
        console.print(
            (
                "[yellow]Audio system not available - starting text mode"
                "[/yellow]\n"
            )
        )
